          ...
          {quickActions.map((action, index) => {
            ...
            return (
              <Link key={index} href={action.href}>
                ...
                >
                  <div className={`p-2 rounded-lg transition-colors ${action.color === 'red' ? 'bg-red-50 dark:bg-red-900/20 group-hover:bg-red-100 dark:group-hover:bg-red-900/30' :
                    ...
                    <IconComponent className={`h-5 w-5 sm:h-6 sm:w-6 ${action.color === 'red' ? 'text-red-600 dark:text-red-400' :
